//Calculando Area con GUI
//Cristian Berume Ramírez
...
public class _p140_AreaTrianguloGUI extends JFrame implements ActionListener {
    ...
    public _p140_AreaTrianguloGUI() {
        ...
        txtBase = new JTextField(); txtBase.setBounds(60, 20, 200, 30); add(txtBase);
        txtAltura = new JTextField(); txtAltura.setBounds(60, 50, 200, 30); add(txtAltura);
        lblResultado = new JLabel("[Resultado Aqui]"); lblResultado.setBounds(90, 80, 200, 30); add(lblResultado);
        btnCalcular = new JButton("Calcular"); btnCalcular.setBounds(20, 110, 100, 40); add(btnCalcular);
        btnSalir = new JButton("Salir"); btnSalir.setBounds(160, 110, 100, 40); add(btnSalir);
