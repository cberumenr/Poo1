//Calcula el mayor, el menor y busca en un arreglo de numeros flotantes usando funciones
public class _p87_ArregloTemperaturas {
    ...
    public static void main(String[] args) {
        double[] temps = {12.34, 56.22, 56.78, 10.0, 10.25, 60.22, 10.00};

        System.out.print("\033[H\033[2J");System.out.flush();
        System.out.println("\nTemperaturas"); Mostrar(temps);
        ...
        if(pos != -1)
            ...
            System.out.println("\nEl elemento a buscado no existe en el arreglo temperaturas");
    }
}
